...
function getTreasureSprite(size) {
  ...
  function drawCompactSelectorField(targetCtx, x, y, width, height, label, value, onClick, register) {
  ...
  function drawEditorChoiceRow(targetCtx, x, y, width, rowKey, title, buttons) {
    ...
    buttons.forEach(function (button) {
      const visible = cursorX + button.width > viewportX && cursorX < viewportX + viewportW && rowY + rowH > bodyViewportY && rowY < bodyViewportY + bodyViewportH;
      if (visible) {
        ...
        registerClippedRegion(overlayRegions, cursorX, rowY, button.width, rowH, viewportX, bodyViewportY, viewportW, bodyViewportH, button.onClick);
      }
  ...
  function renderEditorModal(targetCtx, view) {
    ...
    selectorRows[0].forEach(function (entry, index) {
      ...
      const register = y + selectorFieldH > bodyViewportY && y < bodyViewportY + bodyViewportH;
      drawCompactSelectorField(targetCtx, x, y, selectorW, selectorFieldH, entry.label, entry.value, entry.onClick, register);
    });
